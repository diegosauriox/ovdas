"""
Django settings for trazas project.
...
SECRET_KEY = 'jh194&p^68t+9db3d%g8_c4!6+&kfs(uf=ek61)x+zdlvxz83x'
...
INSTALLED_APPS = [
    ...
    'algoritmoPick.apps.AlgoritmopickConfig',
    'avistamientoRegistro.apps.AvistamientoregistroConfig',
    'eventoLocali.apps.EventolocaliConfig',
...
WSGI_APPLICATION = 'trazas.wsgi.application'
