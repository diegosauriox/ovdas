...
class Alerta(models.Model):
    alerta_id = models.AutoField(primary_key=True)
    evento = models.ForeignKey('EventoMacro', models.DO_NOTHING)
...
class IdentificacionSenal(models.Model):
    ...
    fecha_pick = models.CharField(max_length=30, blank=True, null=True)
    ...
    campo_1 = models.CharField(max_length=45, blank=True, null=True)
    campo_2 = models.CharField(max_length=45, blank=True, null=True)
    campo_3 = models.CharField(max_length=45, blank=True, null=True)
    campo_4 = models.CharField(max_length=45, blank=True, null=True)
    campo_5 = models.CharField(max_length=45, blank=True, null=True)
    campo_6 = models.CharField(max_length=45, blank=True, null=True)
    campo_7 = models.CharField(max_length=45, blank=True, null=True)
    campo_8 = models.CharField(max_length=45, blank=True, null=True)
    campo_9 = models.CharField(max_length=45, blank=True, null=True)
    campo_10 = models.CharField(max_length=45, blank=True, null=True)
    created_at = models.DateTimeField()
    updated_at = models.DateTimeField(blank=True, null=True)
...
class ParmFisDiscreto(models.Model):
    parm_discr_fisc_id = models.AutoField(primary_key=True)
...
class ParmFisDiscretoEst(models.Model):
    fecha = models.CharField(max_length=45, blank=True, null=True)
    code_event = models.ForeignKey(IdentificacionSenal, models.DO_NOTHING, db_column='code_event')
